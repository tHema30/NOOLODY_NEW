            ...
            <div className="row g-4">
              ...
              >
                <div className="bg-white text-center h-100 p-4 p-xl-5">
                  ...
                  <p className="mb-4">
                    We provide doorstep service that means, we’ll come at your
                    place to take measurement and collect your cloth/fabric as
                    per your given time and date.
                  </p>
                  <a
              ...
              >
                <div className="bg-white text-center h-100 p-4 p-xl-5">
                  ...
                  <p className="mb-4">
                    Post which the stitching happens at our Production House and
                    then we get it delivered to you and if there will be any
                    alteration required, We will redo again and redeliver it at
                    your place.
                  </p>
                  <a
                    className="btn btn-outline-primary border-2 py-2 px-4 rounded-pill"
              ...
              >
                <div className="bg-white text-center h-100 p-4 p-xl-5">
                  ...
                  <p className="mb-4">
                    We have a team of experienced tailors and designers, all
                    outfit will be stitched under experts guidance.Our online
                    tailors for ladies will curate excellent outfits for your
                    formal events.
                  </p>
                  <a
                    className="btn btn-outline-primary border-2 py-2 px-4 rounded-pill"
