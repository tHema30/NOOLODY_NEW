        ...
        <div className="container">
            <div className="row g-5">
                <div className="col-lg-3 col-md-6">
                    ...
                    <p>For a better user experience, we offer free pick-up and delivery services.</p>
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <p>Design your own Beautiful dress and home essentials with just one click</p>
